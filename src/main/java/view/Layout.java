...
public class Layout extends JFrame {
	...
	public Layout() {
		...
		lblLogo = new JLabel("");
		lblLogo.setIcon(new ImageIcon("C:\\Users\\nnmin\\Downloads\\ProjectUpdate\\Code\\BKHN_JAVA_NEW_1\\image\\logo\\Logo2.png"));
...
//		ViewHome.Home ll = new ViewHome.Home();
		...
		gl_Header.setHorizontalGroup(
			gl_Header.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Header.createSequentialGroup()
					.addGap(27)
					.addComponent(lblLogo, GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
					.addGap(18)
					.addComponent(btnHome, GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
					.addGap(80)
					.addComponent(btnCategory, GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
					.addGap(80)
					.addComponent(btnReport, GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
					.addGap(63)
		...
		gl_Header.setVerticalGroup(
			gl_Header.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_Header.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblLogo, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
					.addGap(12))
				.addGroup(gl_Header.createSequentialGroup()
					.addGap(48)
