...
//-----------------------------Table Import---------------------------------------------------------------
	...
	protected void btnStatisticsByDayActionPerformed(ActionEvent e) {
		...
		if (selectedDate == null) {
		    JOptionPane.showMessageDialog(null, "Please select a date for statistical analysis", "Notification", JOptionPane.WARNING_MESSAGE);
		...
		if (billList.isEmpty() && importNoteList.isEmpty()) {
		    JOptionPane.showMessageDialog(null, "The selected date has no available data", "Notification", JOptionPane.ERROR_MESSAGE);
	...
	protected void btnStatisticsByMonthActionPerformed(ActionEvent e) {
		...
		if (selectedDate == null) {
		    JOptionPane.showMessageDialog(null, "Please select a month for statistical analysis", "Notification", JOptionPane.WARNING_MESSAGE);
		    return; // Kết thúc phương thức nếu selectedDate là null
		}
		LocalDate localDate = selectedDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
		// Lấy dữ liệu từ cơ sở dữ liệu
		...
		// Kiểm tra xem có bản ghi nào tồn tại không
		if (billList.isEmpty() && importNoteList.isEmpty()) {
		    JOptionPane.showMessageDialog(null, "The selected month has no available data.", "Notification", JOptionPane.ERROR_MESSAGE);
		    return; // Kết thúc phương thức nếu không có dữ liệu
		}
		///Table bill
	...
	protected void btnStatisticsByYearActionPerformed(ActionEvent e) {
		...
		if (selectedDate == null) {
		    JOptionPane.showMessageDialog(null, "Please select a year for statistical analysis", "Notification", JOptionPane.WARNING_MESSAGE);
		    return; // Kết thúc phương thức nếu selectedDate là null
		}
		LocalDate localDate = selectedDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
		// Lấy dữ liệu từ cơ sở dữ liệu
