...
public class NhapKho extends JPanel {
	...
	protected void btnAddActionPerformed(ActionEvent e) {
	    ...
	    if (!idProText.matches("\\d+")) {
	    	...
	    	JOptionPane.showMessageDialog(null, "ID Product must be numeric.");
	        return;
	    }
	    ...
	    if (!quantityProText.matches("\\d+")) {
		 ...
		 din.setIdPro(Integer.parseInt(idProText));
		 din.setQuantityPro(Integer.parseInt(quantityProText));
	...
	protected void btnUpdateActionPerformed(ActionEvent e) {
		...
		din.setNameIN(txtNameRe.getText());
		din.setCostDIN(Float.parseFloat(txtCostDIN.getText()));
		din.setQuantityDIN(Integer.parseInt(quantityProText));
